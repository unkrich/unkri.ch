...
<svelte:head>
	...
	<meta name="description" content="unkri.ch blog" />
...
<article
	class="mx-auto container mb-16 flex flex-col items-start justify-center"
>
	<header style="width: 100%;" class="mb-10">
		<div>
			<div class="post-details">
				Written by <a href="/me">Kevin Unkrich</a> on <time>{new Date(json.date).toISOString().slice(0, 10)}</time>
			</div>
			<h1>{json.title}</h1>
			<div class="post-meta">
				<div class="tags">
					<a class="tag-svelte" href="/tags/svelte">svelte</a><a class="tag-web api" href="/tags/web-api">web api</a><a class="tag-projects" href="/tags/projects">projects</a>
				</div>
			</div>
		</div>
	</header>
...
<div class="mx-auto max-w-2xl pb-8">
	<div class="prose mb-12 border-t border-b border-blue-800 p-4 dark:prose-invert">
		{#if json.ghMetadata.reactions.total_count > 0}
			...
			/>
		{:else}
			<a href={json.ghMetadata.issueUrl}>Leave a comment </a>
